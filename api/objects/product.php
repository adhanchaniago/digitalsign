...
class Product{
    ...
    function read(){
        ...
        // select all query
        $query = "SELECT
                    c.name as category_name, p.id, p.name, p.description, p.pdf_url, p.org_pdf, p.sign_pdf, p.category_id, p.created
                FROM
                    " . $this->table_name . " p
                    LEFT JOIN
                        categories c
    ...
    function create(){
        ...
        $query = "INSERT INTO
                ...
                SET
                    ...
                    pdf_url=:pdf_url, pdf_password=:pdf_password, org_pdf=:org_pdf, sign_pdf=:sign_pdf, category_id=:category_id, created=:created";
    ...
    function readOne(){
        ...
        $this->pdf_url = $row['pdf_password'];
        $this->org_pdf = $row['org_pdf'];
